...
export default function MyApp(props: MyAppProps) {
  ...
  return (
    <CacheProvider value={emotionCache}>
      ...
      <Meta
        title={'Opensource Liquidity Protocol'}
        description={
          'Phoenix is an Opensource Protocol that Enables Non-Custodial Liquidity Markets to earn interest on supplying and borrowing assets with a variable or stable interest rate. The protocol is designed for easy integration into your products and services.'
        }
        imageUrl="https://nftstorage.link/ipfs/bafkreibldt2jrpkfibcjd3ppnyeyhbptlqj7emvk5f57udhtarozkfpk44"
      />
      <LanguageProvider>
